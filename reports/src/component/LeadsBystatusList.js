...
const LeadsByStatusList = () => {
  ...
  const fromRef = useRef(null); // ✅ Create ref for From date input
  const toRef = useRef(null);   // ✅ Create ref for To date input
        ...
        <div className="overflow-x-auto px-6 pb-6">
          <table className="w-full text-sm text-left border-collapse border border-gray-300">
            <thead className="bg-gray-100 text-gray-700 uppercase text-xs font-semibold">
              <tr>
                <th className="px-4 py-2 border border-gray-300 text-left w-[10%]">
                  SR. NO.
                </th>
                <th className="px-4 py-2 border border-gray-300 w-[30%]">
                  LEADS STATUS
                </th>
                <th className="px-4 py-2 border border-gray-300 text-left w-[20%]">
                  LEADS
                </th>
              </tr>
            </thead>
