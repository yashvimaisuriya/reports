...
const LeadsStatusTable = () => {
  ...
  return (
    <div className="bg-[#e9edf0] min-h-screen flex justify-center items-center">
      <div className="bg-white shadow-sm border border-gray-200 rounded-md w-[90%] max-w-6xl">
        ...
        {/* Footer */}
        <div className="flex justify-between items-center px-4 py-2  border-gray-200 text-sm text-gray-600">
          {/* Left: Entries info */}
          <span className="text-gray-500 text-[13px]">
            ...
            <span className="font-semibold text-gray-700">{data.length}</span> entries
          </span>

          {/* Right: Pagination with disabled look */}
          <div className="flex items-center space-x-2">
            <button
              disabled
